...
;pick-up_mcr_drive_mcr_pick-up_mcr_drive_mcr_drop remove ?s1x4x7
(:action dynamicmacro_eff_12 :parameters (?v - vehicle ?l - location ?p - package ?s1 - capacity-number ?s2 - capacity-number ?l2x5 - location ?px3x6 - package ?l2x5x6x8 - location)
