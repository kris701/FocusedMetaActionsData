...
;fill-shot_mcr_pour-shot-to-used-shaker remove ?h2
(:action dynamicmacro_pre_3 :parameters (?s - shot ?i - ingredient ?h1 - hand ?d - dispenser ?dx5 - shaker ?lx6 - level ?l1x7 - level)
:precondition (and (holding ?h1 ?s)
(dispenses ?d ?i)
(empty ?s)
(clean ?s)
