...
;lift_mcr_load remove ?x
(:action dynamicmacro_eff_1 :parameters (?y ?z ?p ?zx4)
:precondition (and 
(crate ?y) (surface ?z) (place ?p) (truck ?zx4) 
(at ?y ?p)
(on ?y ?z)
(clear ?y)
(at ?zx4 ?p)
...
;lift_mcr_load remove ?x
(:action dynamicmacro_eff_11 :parameters (?y ?z ?p ?zx4 ?px5)
:precondition (and 
(crate ?y) (surface ?z) (place ?p) (truck ?zx4) (place ?px5)
(at ?y ?p)
(on ?y ?z)
(clear ?y)
(at ?zx4 ?px5)
...
(:action dynamicmacro_eff_16 :parameters (?y ?z ?p ?zx4 ?px5)
:precondition (and 
(crate ?y) (surface ?zx4) (place ?p) (truck ?z) (place ?px5)
(at ?z ?p)
(in ?y ?z)
(at ?zx4 ?px5)
(clear ?zx4)
...
(:action dynamicmacro_pre_1 :parameters (?x ?y ?z ?p ?zx4)
:precondition (and 
(hoist ?x) (crate ?y) (truck ?zx4) (place ?p) (surface ?z)
(at ?x ?p)
(available ?x)
(at ?y ?p)
(on ?y ?z)
