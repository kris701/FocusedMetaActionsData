; Transport two-cities-sequential-2nodes-1000size-2degree-2mindistance-2trucks-2packages-2021seed

(define (problem transport-two-cities-sequential-2nodes-1000size-2degree-2mindistance-2trucks-2packages-2021seed)
 (:domain transport)
 (:objects
