; Transport two-cities-sequential-3nodes-1000size-2degree-50mindistance-2trucks-3packages-2021seed

(define (problem transport-two-cities-sequential-3nodes-1000size-2degree-50mindistance-2trucks-3packages-2021seed)
 (:domain transport)
 (:objects
